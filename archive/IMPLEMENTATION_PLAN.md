> **📦 ARCHIVED 2026-08-26.** Phases 0–6.5 are done and live; the remaining open items (thumbnails, role tagging, backlog) were carried forward into the living plan at [../IMPROVEMENTS_PLAN.md](../IMPROVEMENTS_PLAN.md).
...
- [ ] "ARRI & Friends" appears twice — but the two entries have **different dates** (Dec 2021 vs Aug 2023), They are **distinct events**, not a true duplicate.
- **Files:** `data.json`
